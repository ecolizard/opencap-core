...
#   ...
#Opencapo Example Data
#dataDir = 'C:/Users/lw2175/Dropbox/University/Bath/BioCV/Stroke/OpenCap/Data/Local_Development/OpencapSession/LabValidation_withVideos'

#Bath video data example
dataDir = 'C:\\Users\\lw2175\\Dropbox\\University\\Bath\\BioCV\\Stroke\\BathLocal_Videos'
...
#Opencap Example
#sessionNames = ['subject10_Session0',  
#                'subject11_Session0']
#Bath Video Example
sessionNames = ['subject2_Session0']

#List this as True if you are using bath videos, false for example Opencap videos
BathVid = True
...
augmenter_model = 'v0.3' #Updated this to 0.3 as the latest iteration (LW)
...
#             '2-cameras': ['Cam1', 'Cam3']}
#Adjusted this to work with the cameras that I have. In future need to create this using all cameras available
cam2sUse = {'5-cameras': ['Cam0', 'Cam1', 'Cam2', 'Cam3', 'Cam4'], 
            '3-cameras': ['Cam1', 'Cam2', 'Cam3'], 
            '2-cameras': ['Cam2', 'Cam3']}
...
for count, sessionName in enumerate(sessionNames):    
    ...
    pathCam0 = os.path.join(dataDir, 'Data', sessionName, 'Videos', 'Cam0',
                            'InputMedia')    
    # Work around to re-order trials and have the extrinsics trial first, and
